    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain{
        http
            ...
            .authorizeHttpRequests{
                it.requestMatchers("/api/member/signup", "/api/member/login", "/api/member/info_edit", "/api/member/chat", "/api/member/chat_list").anonymous() // 해당 url에 접속하는 사용자는 인증되지 않은 사용자.
